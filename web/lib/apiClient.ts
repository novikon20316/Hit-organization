...
export const apiClient = {
  ...
  /** POST /api/admin/users/:id/reset-password — system_admin (any user) or
   *  administrative_secretary (students within their own faculty/major scope
   *  only). Generates a new temp password (returned once) and forces a
    ...
    return request<{
      ...
      templates: Array<{
        ...
        milestones: Array<{
          ...
          routing?: Array<{ id: string; role: string; action: 'grade' | 'approve' | 'notify'; rejectTo: string; onlyIfRequiresExaminers?: boolean }>;
        }>;
        createdBy: string;
        ...
        defaultRouting?: Array<{ id: string; role: string; action: 'grade' | 'approve' | 'notify'; rejectTo: string; onlyIfRequiresExaminers?: boolean }>;
