...
// app/workflow-templates/RejectModal.tsx
// Reason textarea for rejecting a pending workflow-template proposal — same
// pattern as app/coordinator/home/RejectMilestoneModal.tsx and
...
export function RejectModal({ open, busy, onCancel, onConfirm }: RejectModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      ...
      >
        ...
        <p className="mt-1 text-sm text-muted">
          {lang === 'he' ? 'יש לציין סיבה — היא תישלח למי שהגיש את ההצעה.' : 'A reason is required — it will be sent to whoever submitted the proposal.'}
        </p>
        <textarea
          value={reason}
