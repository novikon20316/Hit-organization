// app/workflow-templates/fieldGuide.ts
// Single source of truth for both the first-visit FieldGuideOverlay
// walkthrough and every field's inline InfoTooltip on the workflow-template
// proposal form (new/page.tsx) and its milestone editor (MilestoneRowModal.tsx)
// — order here is the walkthrough order, top-to-bottom matching the form's
// visual layout.
...
export const WORKFLOW_TEMPLATE_FIELD_GUIDE: FieldGuideStep[] = [
  {
    ...
    description: {
      he: 'הרשימה של השלבים שכל תהליך (פרויקט/תזה) יעבור, בסדר הזה. כל אבן דרך מגדירה תאריך יעד, אחוז מהציון הסופי, והאם נדרשים בוחנים — לחצו על ✏️ כדי לערוך אבן דרך קיימת או על ״הוסף״ כדי להוסיף חדשה.',
      en: 'The ordered list of stages every process (project/thesis) goes through. Each milestone sets a due date, its share of the final grade, and whether examiners are required — click ✏️ to edit an existing one or "Add" for a new one.',
    },
  },
  {
    key: 'defaultRouting',
