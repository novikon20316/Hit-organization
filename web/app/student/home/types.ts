...
export type StudentState = 'loading' | 'ineligible' | 'no_project' | 'active';
...
export interface PendingApplication {
  ...
  submittedAt: string;
  /** 'awaiting_student_confirmation' = a supervisor approved this application
   *  but the student hasn't yet decided whether to actually start the
