...
// app/program_head/records/page.tsx
// Entry point for the program head's project-records drill-down — lists
// every supervisor within the program head's own faculty scope (see
...
export default function ProgramHeadRecordsPage() {
