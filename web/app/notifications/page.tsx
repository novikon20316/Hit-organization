...
export default function NotificationsPage() {
  ...
  return (
    <DashboardShell
      title={lang === 'he' ? 'התראות והודעות' : 'Notifications & Messages'}
      actions={
        <button type="button" onClick={() => router.push(getHomeRoute(userData?.role))} className="rounded-full border border-line px-3.5 py-1.5 text-sm font-medium text-ink hover:bg-paper">
