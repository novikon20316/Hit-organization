...
type GradSchoolHeadTab = 'overview' | 'approvals' | 'stuck' | 'examiners' | 'grades' | 'staff' | 'students' | 'ungraded';
const GRAD_SCHOOL_HEAD_TABS: GradSchoolHeadTab[] = ['overview', 'approvals', 'stuck', 'examiners', 'grades', 'staff', 'students', 'ungraded'];
