// constants/roleFacultyPicker.ts
// Mirrors web/lib/roleFacultyPicker.ts — keep in sync.
//
// Which roles get the "additional faculties (optional)" picker in
// EditUserModal, and which user-doc field backs each one — see
...
export const ROLE_FACULTY_PICKER_FIELD: Partial<Record<string, RoleFacultyField>> = {
...
export const ROLE_FACULTY_FIELDS: RoleFacultyField[] = [
  'supervisorFacultyIds',
  'secondarySupervisorFacultyIds',
  'facultyAdminFacultyIds',
  'programHeadFacultyIds',
