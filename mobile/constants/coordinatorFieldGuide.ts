// constants/coordinatorFieldGuide.ts
// Mirrors web's app/coordinator/home/fieldGuide.ts — same guideKeys/copy so
...
export const ASSIGN_EXAMINERS_FIELD_GUIDE: FieldGuideStep[] = [
  {
    ...
    description: {
      he: 'לכל בוחן: פנימי (מסגל המוסד, נבחר מרשימה) או חיצוני (שם, אימייל ומוסד מוזנים ידנית). ניתן להוסיף או להסיר בוחנים בכל מספר.',
...
export const PROPOSAL_RECOMMENDATION_FIELD_GUIDE: FieldGuideStep[] = [
  {
    key: 'decision',
    label: { he: 'המלצת רכז הפרויקטים', en: "Coordinator's recommendation" },
    description: {
      he: 'אשרו את ההצעה, אשרו בתנאי (יש לפרט את התנאים בהערה), או דחו (יש לפרט סיבה בהערה).',
      en: "Approve the proposal, approve it conditionally (detail the conditions in the comment), or reject it (detail the reason in the comment).",
    },
  },
];
