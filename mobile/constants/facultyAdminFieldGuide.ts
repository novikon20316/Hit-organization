// constants/facultyAdminFieldGuide.ts
// Mirrors web's app/faculty_admin/dashboard/fieldGuide.ts and
// app/faculty_admin/templates/fieldGuide.ts — same guideKeys/copy so
...
export const EDIT_USER_FIELD_GUIDE: FieldGuideStep[] = [
  ...
  },
  {
    ...
    description: {
      he: 'סטטוס לימודים ראשי של הסטודנט/ית — הרשימה מנוהלת על ידי מנהל/ת המערכת.',
      en: "The student's primary academic status — the list is managed by system_admin.",
    },
  },
  {
    key: 'secondaryStatus',
...
export const TEMPLATE_EDITOR_FIELD_GUIDE: FieldGuideStep[] = [
  {
    ...
    description: {
      he: 'לאיזה תואר התבנית הזו מיועדת.',
      en: 'Which degree this template is meant for.',
    },
  },
  {
    key: 'type',
  ...
  },
  {
    ...
    description: {
      he: 'הכותרת שהמנחה יראה בבחירת תבנית.',
      en: 'The title a supervisor sees when picking a template.',
    },
  },
  {
    key: 'description',
  ...
  },
  {
    ...
    description: {
      he: 'רשימת כישורים מופרדת בפסיקים, מועתקת כברירת מחדל לכל פרויקט שייווצר מהתבנית.',
      en: 'A comma-separated skills list, copied as the default for any project created from this template.',
    },
  },
];
...
export const STUDENTS_TAB_FIELD_GUIDE: FieldGuideStep[] = [
  {
    ...
    description: {
      he: 'רשימה מלאה של הסטודנטים הרשומים לתוכניות של הפקולטה שלכם.',
