// app/program_head/records/[supervisorId].tsx
// Second level of the master's program head's Project Records drill-down:
...
export default function ProgramHeadSupervisorRecordsScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: ap.surface }}>
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
        <Pressable
          onPress={() => (router.canGoBack() ? router.back() : router.replace({ pathname: '/program_head/records', params: { lang } } as any))}
