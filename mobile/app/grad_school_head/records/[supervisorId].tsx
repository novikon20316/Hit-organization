// app/grad_school_head/records/[supervisorId].tsx
// Second level of the graduate school head's Project Records drill-down:
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F7F8FA' }}>
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
        <Pressable
          onPress={() => (router.canGoBack() ? router.back() : router.replace({ pathname: '/grad_school_head/records', params: { lang } } as any))}
