// app/admin/records/projects.tsx
// Fourth (final) level of system_admin's Project Records drill-down: lists
// one supervisor's own projects that already have an enrolled student, then
...
export default function AdminRecordsProjectsScreen() {
  const router = useRouter();
  const { facultyId, major, supervisorId, lang: langParam } = useLocalSearchParams<{
    facultyId?: string; major?: string; supervisorId: string; lang?: string;
  }>();
