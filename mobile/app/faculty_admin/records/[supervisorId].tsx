// app/faculty_admin/records/[supervisorId].tsx
// Second level of the faculty admin's Project Records drill-down: lists one
...
export default function FacultyAdminSupervisorRecordsScreen() {
